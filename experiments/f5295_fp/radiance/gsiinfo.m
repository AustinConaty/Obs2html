...
%%%%%% AMSUB %%%%%%
KXS(137).value = 416;
KXS(137).id    = 'NOAA-16 AMSUB';
KXS(138).value = 417;
KXS(138).id    = 'NOAA-17 AMSUB';
%%%%%% MHS %%%%%%
KXS(139).value = 818;
KXS(139).id    = 'NOAA-18 MHS';
KXS(140).value = 819;
KXS(140).id    = 'NOAA-19 MHS';
KXS(141).value = 825;
KXS(141).id    = 'METOP-A MHS';
KXS(142).value = 826;
KXS(142).id    = 'METOP-B MHS';
%%%%%% AQUA AMSRE %%%%%%
KXS(143).value = 547;
KXS(143).id    = 'AQUA AMSRE LOW';
KXS(144).value = 548;
KXS(144).id    = 'AQUA AMSRE MID';
KXS(145).value = 549;
KXS(145).id    = 'AQUA AMSRE HIGH';
%%%%%% GPS DATA %%%%%%
KXS(146).value = 740;
KXS(146).id    = 'COSMIC-1 RO';
KXS(147).value = 741;
KXS(147).id    = 'COSMIC-2 RO';
KXS(148).value = 742;
KXS(148).id    = 'COSMIC-3 RO';
KXS(149).value = 743;
KXS(149).id    = 'COSMIC-4 RO';
KXS(150).value = 744;
KXS(150).id    = 'COSMIC-5 RO';
KXS(151).value = 745;
KXS(151).id    = 'COSMIC-6 RO';
KXS(152).value = 722;
KXS(152).id    = 'GRACE-A RO';
KXS(153).value = 723;
KXS(153).id    = 'GRACE-B RO';
KXS(154).value = 4;
KXS(154).id    = 'METOP-A RO';
KXS(155).value = 3;
KXS(155).id    = 'METOP-B RO';
KXS(156).value = 41;
KXS(156).id    = 'CHAMP RO';
KXS(157).value = 42;
KXS(157).id    = 'TerraSAR-X RO';
KXS(158).value = 786;
KXS(158).id    = 'C/NOFS CORISS RO';
KXS(159).value = 820;
KXS(159).id    = 'SAC-C RO';

%%%%%% SBUV DATA %%%%%%
KXS(160).value = 457;
KXS(160).id    = 'Nimbus-7 SBUV';
KXS(161).value = 458;
KXS(161).id    = 'NOAA-8 SBUV/2';
KXS(162).value = 459;
KXS(162).id    = 'NOAA-9 SBUV/2';
KXS(163).value = 460;
KXS(163).id    = 'NOAA-10 SBUV/2';
KXS(164).value = 461;
KXS(164).id    = 'NOAA-11 SBUV/2';
KXS(165).value = 462;
KXS(165).id    = 'NOAA-12 SBUV/2';
KXS(166).value = 464;
KXS(166).id    = 'NOAA-14 SBUV/2';
KXS(167).value = 465;
KXS(167).id    = 'NOAA-15 SBUV/2';
KXS(168).value = 466;
KXS(168).id    = 'NOAA-16 SBUV/2';
KXS(169).value = 467;
KXS(169).id    = 'NOAA-17 SBUV/2';
KXS(170).value = 468;
KXS(170).id    = 'NOAA-18 SBUV/2';
KXS(171).value = 469;
KXS(171).id    = 'NOAA-19 SBUV/2';


%%%%%% DMSP RADIANCES %%%%%%
KXS(172).value  = 708;
KXS(172).id     = 'DMSP F-08 SSM/I';
KXS(173).value  = 710;
KXS(173).id     = 'DMSP F-10 SSM/I';
KXS(174).value  = 711;
KXS(174).id     = 'DMSP F-11 SSM/I';
KXS(175).value  = 713;
KXS(175).id     = 'DMSP F-13 SSM/I';
KXS(176).value  = 714;
KXS(176).id     = 'DMSP F-14 SSM/I';
KXS(177).value  = 715;
KXS(177).id     = 'DMSP F-15 SSM/I';


%%%%%% HYPERSPECTRAL INSTRUMENTS %%%%%%
KXS(178).value = 49;
KXS(178).id    = 'Aqua AIRS';
KXS(179).value = 875;
KXS(179).id    = 'METOP-A IASI';
KXS(180).value = 876;
KXS(180).id    = 'METOP-B IASI';

KXS(181).value = 877;
KXS(181).id    = 'METOP-C IASI';

%%%%%% ATMS ON NPP  %%%%%%
KXS(182).value = 900;
KXS(182).id    = 'SNPP ATMS';
%%%%%% CrIS ON NPP  %%%%%%
KXS(183).value = 940;
KXS(183).id    = 'SNPP CrIS-FSR';


%%%%%% SEVIRI ON METEOSAT 9 or 10  %%%%%%
KXS(184).value = 988;
KXS(184).id    = 'METEOSAT-8 SEVIRI';
KXS(185).value = 989;
KXS(185).id    = 'METEOSAT-9 SEVIRI';
KXS(186).value = 990;
KXS(186).id    = 'METEOSAT-10 SEVIRI';


%%%%%% SSMIS ON METEOSAT 9 or 10  %%%%%%
KXS(187).value = 716;
KXS(187).id    = 'F16 SSMIS';
KXS(188).value = 717;
KXS(188).id    = 'F17 SSMIS';
KXS(189).value = 718;
KXS(189).id    = 'F18 SSMIS';


KXS(190).value = 618;
KXS(190).id    = 'NOAA-18 AVHRR';
KXS(191).value = 619;
KXS(191).id    = 'NOAA-19 AVHRR';
KXS(192).value = 625;
KXS(192).id    = 'METOP-A AVHRR';
KXS(193).value = 626;
KXS(193).id    = 'METOP-B AVHRR';
...
%%%%%% ATMS ON N20  %%%%%%
KXS(195).value = 920;
KXS(195).id    = 'NOAA-20 ATMS';
%%%%%% CrIS-FSR ON N20  %%%%%%
KXS(196).value = 960;
KXS(196).id    = 'NOAA-20 CrIS-FSR';

KXS(197).value = 327;
KXS(197).id    = 'METOP-C AMSUA';

KXS(198).value = 827;
KXS(198).id    = 'METOP-C MHS';

KXS(199).value = 550;
KXS(199).id    = 'AMSR2 GCOM W1';

KXS(200).value = 921;
KXS(200).id    = 'NOAA-21 ATMS';
...
SENSORS(3).chns = [1:3];
SENSORS(4).id  = 'AMSUA';
SENSORS(4).kxs = [300 315 317 318 319 325 326 327];
SENSORS(4).chns = 1:15;
SENSORS(5).id  = 'AMSUB';
SENSORS(5).kxs = [416 417];
SENSORS(5).chns = 1:5;
SENSORS(6).id  = 'MHS';
SENSORS(6).kxs = [818 819 825 826 827];
SENSORS(6).chns = 1:5;
SENSORS(7).id  = 'SSMI';
SENSORS(7).kxs = [];
SENSORS(7).chns = [];
...
SENSORS(19).id  = 'ATMS';
SENSORS(19).kxs = [900 920 921];
SENSORS(19).chns = 1:22;
SENSORS(20).id  = 'SEVIRI';
SENSORS(20).kxs = [988 989 990];
SENSORS(20).chns = 1:8;
SENSORS(21).id  = 'SSMIS';
SENSORS(21).kxs = [716 717 718];
SENSORS(21).chns = 1:24;
SENSORS(22).id  = 'AVHRR';
SENSORS(22).kxs = [618 619 625 626];
SENSORS(22).chns = 1:3;
SENSORS(23).id  = 'GMI';
SENSORS(23).kxs = [706];
SENSORS(23).chns = 1:13;
SENSORS(24).id  = 'CrIS-FSR';
SENSORS(24).kxs = [940 960];
SENSORS(24).chns = 1:431;
SENSORS(25).id  = 'AMSR2 GCOM W1';
SENSORS(25).kxs = [550];
SENSORS(25).chns = 1:14;
