...
KXS(70).value = 285;
KXS(70).id    = 'RapidSCAT SCATTEROMETER WINDS OVER OCEAN U, V';
KXS(71).value = 286;
...
% ------------------------
KXS(79).value = 199;
KXS(79).id    = 'Drifting Buoy (mass)';
KXS(80).value = 299;
KXS(80).id    = 'Drifting Buoy (winds)';
KXS(81).value = 244;
KXS(81).id    = 'AVHRR cloud track winds';
KXS(82).value = 240;
KXS(82).id    = 'NESDIS IR SW CLOUD DRIFT(GOES)';
KXS(83).value = 260;
KXS(83).id    = 'VIIRS IR LW CLOUD DRIFT WINDS';

%%%%%% GPS DATA %%%%%%
KXS(84).value = 825;
KXS(84).id    = 'KOMPSAT-5 RO';
KXS(85).value = 740;
KXS(85).id    = 'COSMIC-1 RO';
KXS(86).value = 741;
KXS(86).id    = 'COSMIC-2 RO';
KXS(87).value = 742;
KXS(87).id    = 'COSMIC-3 RO';
KXS(88).value = 743;
KXS(88).id    = 'COSMIC-4 RO';
KXS(89).value = 744;
KXS(89).id    = 'COSMIC-5 RO';
KXS(90).value = 745;
KXS(90).id    = 'COSMIC-6 RO';
KXS(91).value = 722;
KXS(91).id    = 'GRACE-A RO';
KXS(92).value = 723;
KXS(92).id    = 'GRACE-B RO';
KXS(93).value = 41;
KXS(93).id    = 'CHAMP RO';
KXS(94).value = 43;
KXS(94).id    = 'TANDEM-X RO';
KXS(95).value = 42;
KXS(95).id    = 'TerraSAR-X RO';
KXS(96).value = 786;
KXS(96).id    = 'C/NOFS CORISS RO';
KXS(97).value = 820;
KXS(97).id    = 'SAC-C RO';
KXS(98).value = 4;
KXS(98).id    = 'METOP-A RO';
KXS(99).value = 3;
KXS(99).id    = 'METOP-B RO';
KXS(100).value = 5;
KXS(100).id    = 'METOP-C RO';
KXS(101).value = 750;
KXS(101).id    = 'COSMIC-2 E1 RO';
KXS(102).value = 751;
KXS(102).id    = 'COSMIC-2 E2 RO';
KXS(103).value = 752;
KXS(103).id    = 'COSMIC-2 E3 RO';
KXS(104).value = 753;
KXS(104).id    = 'COSMIC-2 E4 RO';
KXS(105).value = 754;
KXS(105).id    = 'COSMIC-2 E5 RO';
KXS(106).value = 755;
KXS(106).id    = 'COSMIC-2 E6 RO';
KXS(107).value = 44;
KXS(107).id    = 'PAZ RO';
KXS(108).value = 265;
KXS(108).id    = 'GeoOptics RO';
KXS(109).value = 269;
KXS(109).id    = 'Spire RO';
KXS(110).value = 304;
KXS(110).id    = 'MLS Temperature';
KXS(111).value = 267;
KXS(111).id    = 'PlanetIQ RO';
...
SENSORS(1).kxs = [6 7 8 9 10 11 12 14 15 16 17 18 19 25];
SENSORS(1).chns = 1:19;
SENSORS(2).id  = 'MSU';
...
%%%%%% SBUV DATA %%%%%%
%KXS(149).value = 457;
%KXS(149).id    = 'Nimbus-7 SBUV';
%KXS(150).value = 458;
%KXS(150).id    = 'NOAA-8 SBUV/2';
%KXS(151).value = 459;
%KXS(151).id    = 'NOAA-9 SBUV/2';
%KXS(152).value = 460;
%KXS(152).id    = 'NOAA-10 SBUV/2';
%KXS(153).value = 461;
%KXS(153).id    = 'NOAA-11 SBUV/2';
%KXS(154).value = 462;
%KXS(154).id    = 'NOAA-12 SBUV/2';
%KXS(155).value = 464;
%KXS(155).id    = 'NOAA-14 SBUV/2';
%KXS(156).value = 465;
%KXS(156).id    = 'NOAA-15 SBUV/2';
%KXS(157).value = 466;
%KXS(157).id    = 'NOAA-16 SBUV/2';
%KXS(158).value = 467;
%KXS(158).id    = 'NOAA-17 SBUV/2';
%KXS(159).value = 468;
%KXS(159).id    = 'NOAA-18 SBUV/2';
%KXS(160).value = 469;
%KXS(160).id    = 'NOAA-19 SBUV/2';


%%%%%% DMSP RADIANCES %%%%%%
%KXS(161).value  = 708;
%KXS(161).id     = 'DMSP F-08 SSM/I';
%KXS(162).value  = 710;
%KXS(162).id     = 'DMSP F-10 SSM/I';
%KXS(163).value  = 711;
%KXS(163).id     = 'DMSP F-11 SSM/I';
%KXS(164).value  = 713;
%KXS(164).id     = 'DMSP F-13 SSM/I';
%KXS(165).value  = 714;
%KXS(165).id     = 'DMSP F-14 SSM/I';
%KXS(166).value  = 715;
%KXS(166).id     = 'DMSP F-15 SSM/I';


%%%%%% HYPERSPECTRAL INSTRUMENTS %%%%%%
%KXS(167).value = 49;
%KXS(167).id    = 'Aqua AIRS';
%KXS(168).value = 875;
%KXS(168).id    = 'METOP-A IASI';

% Kovach
% Ocean data source descriptions
% ------------------------------
%KXS(169).value = 501;
%KXS(169).id    = 'TAO Mooring';
%KXS(170).value = 502;
%KXS(170).id    = 'Pirata Mooring';
%KXS(171).value = 503;
%KXS(171).id    = 'XBT';
%KXS(172).value = 505;
%KXS(172).id    = 'Drifting Buoy';
%KXS(173).value = 507;
%KXS(173).id    = 'Palace Float';
%KXS(174).value = 508;
%KXS(174).id    = 'Argo Float';
%KXS(175).value = 512;
%KXS(175).id    = 'Derived Profile';
%KXS(176).value = 513;
%KXS(176).id    = 'CTD Station';
%KXS(177).value = 514;
%KXS(177).id    = 'Topex Altimeter';
%KXS(178).value = 515;
%KXS(178).id    = 'Jason Altimeter';
