...
KXS(145).id    = 'CHAMP RO';
KXS(146).value = 42;
KXS(146).id    = 'TerraSAR-X RO';
KXS(147).value = 786;
KXS(147).id    = 'C/NOFS CORISS RO';
KXS(148).value = 820;
KXS(148).id    = 'SAC-C RO';
...
KXS(161).value = 449;
KXS(161).id    = 'AURA OMI total column ozone';
KXS(162).value = 330;
KXS(162).id    = 'AURA MLS55 level ozone';
...
KXS(171).value = 427;
KXS(171).id    = 'OMPSNM SNPP total column ozone';
KXS(172).value = 337;
KXS(172).id    = 'OMPS LP SNPP level ozone';
