...
KXS(1).value = 301;
KXS(1).id    = 'TERRA MODIS Aerosol (Ocean Algorithm)';
KXS(2).value = 302;
KXS(2).id    = 'TERRA MODIS Aerosol (Land Algorithm)';
KXS(3).value = 311;
KXS(3).id    = 'AQUA MODIS Aerosol (Ocean Algorithm)';
KXS(4).value = 312;
KXS(4).id    = 'AQUA MODIS Aerosol (Land Algorithm)';
KXS(5).value = 313;
