...
k = k + 1;
s(k).id = 'TERRA MODIS Aerosol (Ocean Algorithm)';
s(k).kt = 43;
s(k).kx = 301;
s(k).plev = plev;

k = k + 1;
s(k).id = 'TERRA MODIS Aerosol (Land Algorithm)';
s(k).kt = 43;
s(k).kx = 302;
s(k).plev = plev;

k = k + 1;
s(k).id = 'AQUA MODIS Aerosol (Ocean Algorithm)';
s(k).kt = 43;
s(k).kx = 311;
s(k).plev = plev;

k = k + 1;
s(k).id = 'AQUA MODIS Aerosol (Land Algorithm)';
s(k).kt = 43;
s(k).kx = 312;
s(k).plev = plev;
...
k = k + 1;
s(k).id = 'AVHRR Bias Corrected Aerosol';
s(k).kt = 43;
s(k).kx = 324;
s(k).plev = plev;
